...
namespace LHP.Web.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoomTypeId,Description,Amount")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoomTypeId,Description,Amount")] RoomType roomType)
        {
            if (ModelState.IsValid)
            {
